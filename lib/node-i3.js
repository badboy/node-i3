...
i3.prototype.tree = function() {
  this.write(this._format(constants.TYPES.GET_TREE));
  return this;
}
i3.prototype.marks = function() {
  this.write(this._format(constants.TYPES.GET_MARKS));
  return this;
}
i3.prototype.barConfig = function() {
  this.write(this._format(constants.TYPES.GET_BAR_CONFIG));
  return this;
}
